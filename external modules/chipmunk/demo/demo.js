...
var Demo = function() {
	...
	this.canvas.onmousemove = function(e) {
		// self.mouse = canvas2point(e.clientX, e.clientY); hcchen5600 2015/03/27 16:15:01 
	...
	this.canvas.onmousedown = function(e) {
		...
		// self.mouse = canvas2point(e.clientX, e.clientY); hcchen5600 2015/03/27 16:24:01 
		self.mouse = canvas2point(e.offsetX, e.offsetY);

		if(!rightclick && !self.mouseJoint) {
			// var point = canvas2point(e.clientX, e.clientY); hcchen5600 2015/03/27 16:24:21 
	...
	this.canvas.onmouseup = function(e) {
		var rightclick = e.which === 3; // or e.button === 2;
		// self.mouse = canvas2point(e.clientX, e.clientY); hcchen5600 2015/03/27 16:24:54 
		self.mouse = canvas2point(e.offsetX, e.offsetY);
...
window.onresize = function(e) {
	...
	// var width = Demo.prototype.width = canvas.width; // hcchen5600 2015/03/27 15:56:35 
	// var height = Demo.prototype.height = canvas.height;
