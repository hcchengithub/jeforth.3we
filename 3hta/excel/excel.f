	...
	: excel.app.count 	( -- count ) \ excel.exe instance count, I can only handle 1. 
						...
						/// GetObject(,"excel.application") returns an exeel.app object but 
						/// if there were multiple excel.app then we don't know which one is 
						/// it. Only one excel.app is allowed is the workaround.
